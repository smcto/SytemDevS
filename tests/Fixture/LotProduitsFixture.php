 ...
 *
 */
class LotProduitsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'etat' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'date_facture' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'numero_facture' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'date_facture' => '2019-11-13',
                'numero_facture' => 'Lorem ipsum dolor sit amet',
                'quantité' => 1
            ],
        ];
        parent::init();
