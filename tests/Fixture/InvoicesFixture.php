...
/**
 * DevisFacturesFixture
 *
 */
class DevisFacturesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'moyen_reglements' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        ...
        'echeance_date' => ['type' => 'text', 'length' => 4294967295, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'echeance_value' => ['type' => 'text', 'length' => 4294967295, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        ...
        'col_visibility_params' => ['type' => 'string', 'length' => 350, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => 'type json', 'precision' => null, 'fixed' => null],
        ...
        'modele_devis_factures_category_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'modele_devis_factures_sous_category_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'date_crea' => '2020-06-23',
                'date_sign_before' => '2020-06-23',
                'ref_commercial_id' => 'Lorem ipsum dolor sit amet',
                'note' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
                'client_id' => 1,
                'date_validite' => '2020-06-23',
                'moyen_reglements' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
                'delai_reglements' => 'Lorem ipsum dolor sit amet',
                'echeance_date' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
                'echeance_value' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
                ...
                'col_visibility_params' => 'Lorem ipsum dolor sit amet',
                'info_bancaire_id' => 1,
                'status' => 'Lorem ipsum dolor sit amet',
                'position_type' => 'Lorem ipsum dolor sit amet',
                'created' => '2020-06-23 13:27:55',
                'modified' => '2020-06-23 13:27:55',
                'total_ttc' => 1.5,
                'total_ht' => 1.5,
                'total_reduction' => 1.5,
                'total_remise' => 1.5,
                ...
                'modele_devis_factures_category_id' => 1,
                'modele_devis_factures_sous_category_id' => 1,
