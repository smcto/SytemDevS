...
/**
 * PipelineEtapesFixture
 *
 */
class PipelineEtapesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'pipeline_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'pipeline_id' => 1,
                'created' => '2020-07-01 17:27:56',
                'modified' => '2020-07-01 17:27:56',
                'id_in_sellsy' => 1,
                'rank' => 1
            ],
        ];
