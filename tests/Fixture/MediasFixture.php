...
class MediasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'extension' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-06-12 18:35:03',
                'modified' => '2018-06-12 18:35:03'
            ],
        ];
        parent::init();
    }
