...
class SmsenvoiComponent extends Component{
    ...
    */
    ...
    public function __construct(){
     ...
     define('SMSENVOI_EMAIL', 'benjamin.guyon@impact-pub.com');
    define('SMSENVOI_APIKEY', 'TLZZKN69WZW323AZDE2T');
    ...
    */
    public function sendSMS($recipients,$content,$subtype='PREMIUM',$senderlabel='SMS ENVOI',$senddate='',$sendtime='',$richsms_option='',$richsms_url=''){
        ...
        $this->result=json_decode($this->rawresult,true);
