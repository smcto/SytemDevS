 ...
 * Staffs Model
 *
 * @property \App\Model\Table\OpportuniteStaffsTable|\Cake\ORM\Association\HasMany $OpportuniteStaffs
 *
...
class StaffsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->hasMany('OpportuniteStaffs', [
            'foreignKey' => 'staff_id'
        ]);
    }
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('people_id_in_sellsy')
            ->allowEmpty('people_id_in_sellsy');
