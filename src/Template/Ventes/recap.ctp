...
<?= $this->Html->css('ventes/recap.css', ['block' => true]); ?>
<?= $this->Html->script('Clients/add.js?'.  time(), ['block' => 'script']); ?>
<?= $this->Html->script('ventes/recap.js', ['block' => true]); ?>
...
<?= $this->element('vente/client_contacts', ['client' => $venteEntity->client]) ?>

<?= $this->Form->create($venteEntity, ['url' => ['save'], 'class' => 'step-vente hide-table-empty']); ?>

    <div class="card">
        <div class="card-body">

            <h2>CLIENT ET CONTACTS</h2>
            <div class="row">
                <div class="col-md-6">
                    <div class="row-fluid mb-4">
                        <h3 class="mb-4">Vente</h3>
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= @$yes_or_no_template[$venteEntity->is_sous_location] ?></td>
                                </tr>
                                <tr>
                                    <td>Abonnement BO</td>
                ...
                <div class="col-md-6 <?= empty($venteEntity->documents['_ids']) && !$venteEntity->ventes_devis_uploads ? 'd-none' : '' ?>">
                    <div class="row-fluid mb-4">
                        ...
                        <?php if ($venteEntity->documents && !empty($venteEntity->documents['_ids'])): ?>
                        ...
                        <?php if (empty($venteEntity->documents['_ids']) && !$venteEntity->ventes_devis_uploads): ?>
                            ...
                            <tbody>
                                <?php if ($venteEntity->is_contact_crea_different_than_contact_client) : ?>
                                    <tr >
                                        ...
                                        <td><?= $venteEntity->contact_crea_fullname ?> <?= $venteEntity->contact_crea_lastname ?></td>
                                    </tr>
                                    <tr>
    ...
    <div class="row-fluid clearfix mb-4">
        <?= $this->Form->submit('Enregistrer', ['class' => 'btn btn-primary float-right next']) ?>
        <a href="<?= $this->Url->build(['action' => 'livraison']) ?>" class="btn btn-secondary float-left next">Précédent</a>
    </div>
