        ...
        <div class="nav-wrapper customized-scrollbar">
            <div class="nav-block">
                ...
                <div class="sub-nav-wrapper customized-scrollbar">
                    <?= $this->Html->link('Vue d\'ensemble', ['controller' => 'Bornes', 'action' => 'index'], ['escape' => false, 'class' => 'sub-nav-block'] ); ?>
            ...
            <div class="nav-block">
                ...
                <div class="sub-nav-wrapper customized-scrollbar">
                    ...
                    <?= $this->Html->link('Factures en retard', ['controller' => 'DevisFactures', 'action' => 'facturesRetard'], ['class' => 'sub-nav-block'] ); ?>
            ...
            <div class="nav-block">
                <?= $this->Html->link('<div class="text">Ventes</div>', ['controller' => 'Ventes', 'action' => 'index'], ['escape' => false, 'class' => 'main-nav-wrapper'] ); ?>
                <div class="sub-nav-wrapper customized-scrollbar">
            ...
            <?php /*debug($currentUser['profils_alias']);*/ ?>
            <?php if (array_intersect($currentUser['profils_alias'] , ['admin', 'compta'])): ?>
                <div class="nav-block">
                    <div class="main-nav-wrapper">
                    ...
                    <div class="sub-nav-wrapper customized-scrollbar">
                        ...
                        <?= $this->Html->link('Ventes', ['controller' => 'Ventes', 'action' => 'dashboard'], ['escape' => false, 'class' => 'sub-nav-block'] ); ?>
                    </div>
                </div>
            <?php endif ?>
        </div>
        <div class="header-search-wrapper">
            <?= $this->Form->create(false, ['url' => ['controller' =>'Dashboards' ,'action' => 'recherche']]) ?>
            <div class="header-search-wrap">
                ...
                <input type="text" placeholder="Rechercher" autocomplete="off" class="header-input-search" name="key" />
            </div>
            ...
            <div class="sub-nav-wrapper">
                <div class="search-zone-wrapper">
                    ...
                    <div class="inner-search-zone-wrapper customized-scrollbar">
                        <div class="zone-block">
                            <div class="input-check-wrap">
                                <input type="radio" class="search-zone-type" name="entity" value="clients">
                            </div>
                            <div class="text">
                                Clients
                            </div>
                        ...
                        <div class="zone-block">
                            <div class="input-check-wrap">
                                <input type="radio" class="search-zone-type" name="entity" value="bornes">
                            </div>
                            <div class="text">
                                Bornes
                            </div>
                        ...
                        <div class="zone-block">
                            <div class="input-check-wrap">
                                <input type="radio" class="search-zone-type" name="entity" value="devis">
                            </div>
                            <div class="text">
                                Devis
                            </div>
                        ...
                        <div class="zone-block">
                            <div class="input-check-wrap">
                                <input type="radio" class="search-zone-type" name="entity" value="factures">
                            </div>
                            <div class="text">
                                Factures
                            </div>
                    ...
                    <div class="search-button-wrapper">
                        <?= $this->Form->button('Rechercher', ['class' => 'search-button'] );?>
                    </div>
                </div>
            </div>
