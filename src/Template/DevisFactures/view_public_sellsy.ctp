    ...
    <div class="quotation-main-content-container">
        ...
        <div class="quotation-side-section quotation-detail-section">
            ...
            <div class="inner-quotation-detail-section">
                ...
                <div class="booking-step-container booking-step-one hide-step">
                ...
                <div class="booking-step-container booking-step-two">
                    ...
                    <div class="booking-detail-container">
                        ...
                        <div class="booking-detail-list-wrapper">
                            ...
                            <?php if (!$isLastFindedEcheanceSameAsTotalDevisAmount): /*quand le dernier acompte à payer = le solde , ne pas rajouter une ligne supplémentaire "régler la totalité du document", car ça revient au même.*/ ?>
                                    <div class="booking-block echeance-container">
                                            ...
                                            <div class="outer-booking-info-wrap">
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <?php if (
                                                        ...
                                                        <div class="booking-info-wrap">
                                                            <div class="medium-bold darker-gray-text">
                                                                <label for="echeance-total_remaining">Document payé le <?= $devisFacturesEntity->date_total_paiement ?></label>
                                                            </div>
                                                            <div class="booking-amount medium-bold darker-gray-text">
                                                                <span class="amount-pay"> <?= $this->Number->currency($devisFacturesEntity->montant_total_paid, 'EUR'); ?></span>
                                                            </div>
                                                        </div>
                                                    <?php endif ?>
