...
<!-- DEVIS FACTURE -->
<?= $this->Html->script('devisFactures/view_public.js?'.  time(), ['block' => 'script']); ?>
...
<div class="quotation-container">
    ...
    <div class="quotation-header-wrapper">
        ...
        <div class="left-quotation-header-wrapper">
            ...
            <div class="inner-left-header-wrapper">
                ...
                <div class="left-header-detail-wrapper">
                    ...
                    <div>
                        ...
                        <div class="mobile-more-client-data">
                            <?php $this->start('factureInfos') ?>
                                <b><?= $devisFacturesEntity->get('BorneTypeAsText') ?></b> <br>
                                <?= $devisFacturesEntity->client_nom ?> <br>
                                N° <?= $devisFacturesEntity->indent ?>
                            <?php $this->end() ?>

                            <?= $this->fetch('factureInfos') ?>
                        </div>
            ...
            <?php if ($devisFacturesEntity->status == 'paid'): ?>
                ...
                <div class="top-right-quotation-header-wrapper">
                    ...
                    <div class="booking-top-total-amount">
                        <?= $this->Number->currency($devisFacturesEntity->get('total_ht'), 'EUR'); ?> <span class="ttc-icon">ht</span>
                    </div>
    ...
    <div class="header-option-wrapper hide-for-mobile">
        ...
        <div class="inner-header-option-wrapper">
            ...
            <div class="option-block booking-option-block <?= $devisFacturesEntity->get('ClientType') != 'corporation' ? '' : 'current' ?>">
    ...
    <div class="mobile-option-menu-container">
        ...
        <div class="mobile-option-block mobile-booking-block current">
            <div class="text">
                Votre facture
            </div>
        </div>
    ...
    <div class="quotation-main-content-container">
        ...
        <div class="quotation-side-section quotation-detail-section">
            ...
            <div class="inner-quotation-detail-section">
                ...
                <div class="booking-step-container booking-step-one <?= $devisFacturesEntity->get('IsPartiallyPaid') || $devisFacturesEntity->status == 'paid' || $isClientPro ? 'hide-step' : ''; /*je suis sur une facture pro, et on affiche le bloc de paiement direct,*/ ?>">
                ...
                <div class="booking-step-container booking-step-two  <?= !($devisFacturesEntity->get('IsPartiallyPaid') || $devisFacturesEntity->status == 'paid' || $isClientPro) ? 'hide-step' : ''; /*je suis sur une facture pro, et on affiche le bloc de paiement direct,*/ ?>">

                    <div class="booking-detail-container">

                        <div class="outer-booking-title">
        
                            <?php if ($devisFacturesEntity->get('ClientType') == 'person'): ?>
                        ...
                        <div class="booking-instruction-wrapper">
                            ...
                            <?php else: ?>
                                ...
                                <!-- A virer +tard si ticket = ok -->
                                    ...
                                    <?php else: ?>
                                        <p>
                                            Veuillez régler l'acompte via le module ci-dessous ou, si vous souhaitez, réglez dès à présent l'intégralité.
                                        </p>
                                    <?php endif ?>
                                </div>
                                <!-- / fin -->
                        ...
                        <div class="booking-detail-list-wrapper">
                            ...
                            <?php if (!$isLastFindedEcheanceSameAsTotalDevisAmount || $devisFacturesEntity->get('NbEcheancePaid') == 0): /*quand le dernier acompte à payer = le solde , ne pas rajouter une ligne supplémentaire "régler la totalité du document", car ça revient au même.*/ ?>
                                    <div class="booking-block echeance-container">
                                            ...
                                            <div class="outer-booking-info-wrap">
                                                ...
                                                <?php if ($devisFacturesEntity->status != 'paid'): ?>
                                                    ...
                                                    <div class="booking-info-wrap top-booking-info-wrap mt-2">
                                                        ...
                                                        <div class="booking-amount medium-bold darker-gray-text">
                                                            <div class="booking-amount medium-bold darker-gray-text">
                                                                <span> <?= $this->Number->currency($devisFacturesEntity->get('ResteEcheanceImpayeeSansTva'), 'EUR'); ?> HT</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="booking-info-wrap">
                                                        ...
                                                        <div class="booking-amount medium-bold darker-gray-text">
                                                            <span class="amount-pay"> <?= $this->Number->currency($devisFacturesEntity->get('ResteEcheanceImpayee'), 'EUR'); ?> TTC</span>
                                                        </div>
                                                    </div>
                ...
                <div class="booking-step-container booking-step-three hide-step">
                    ...
                    <div class="booking-detail-container">
                        ...
                        <div class="booking-instruction-wrapper">
                            ...
                            <?= $this->Form->create($devisFacturesEntity, ['url' => ['controller' => 'devisFactures', 'action' => 'makeReglement', $devisFacturesEntity->id, 'lang' => 'fr'], 'class' => 'form-other-payment']); ?>
                                ...
                                <p class="">
                                    Montant : <?= $this->Number->currency($devisFacturesEntity->total_ttc, 'EUR'); ?>
                                </p>

                                <p class="">
                                    Référence : <?= $devisFacturesEntity->indent; ?>
                                </p>
        ...
        <div class="quotation-side-section quotation-document-section">
            ...
            <div class="document-preview-wrapper quotation-preview-wrapper display hide-for-mobile">
                ...
                <?php $this->start('pdf_iframe') ?>
                    ...
                    <!--<iframe src="<?= $this->Url->build($devisFacturesEntity->get('PublicPdfUrl')) ?>" type="application/pdf" title="devis" class="object-pdf pdf-doc-file pdf-safari-desktop"></iframe>-->

                    <!--<iframe src="https://mozilla.github.io/pdf.js/web/viewer.html?file=<?= $this->Url->build($devisFacturesEntity->get('PublicPdfUrl'), true) ?>" width="100%" height="100%" class="pdf-doc-file pdf-desktop-all"></iframe>-->
    ...
    <div class="outer-popup-container">
        ...
        <div class="inner-popup-container customized-scrollbar">
            ...
            <div class="col-md-12 m-t-15">
                <?php echo $documentMarketing->cgl_pro ?>
            </div>
