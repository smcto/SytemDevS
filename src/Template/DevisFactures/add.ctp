...
<?php $this->Html->script('devisFactures/add.js?time='.time(), ['block' => 'script']); ?>
<?php $this->Html->script('devisFactures/autre.js?time='.time(), ['block' => 'script']); ?>
<?php $this->Html->script('devisFactures/corps.js?time='.time(), ['block' => 'script']); ?>
...
<?php $custum_title = ($id || $hasModel)?'Modification facture':'Création facture';?>

<?php $this->start('bloc_btn') ?>
    <div class="float-right">
        <?php if($devisFacturesEntity->id) : ?>
            <a href="<?= $this->Url->build($devisFacturesEntity->get('EncryptedUrl')) ?>" target="_blank" class="btn btn-sm btn-rounded btn-primary">Version web</a>
            <a href="<?= $this->Url->build(['controller' => 'DevisFactures', 'action' => 'pdfversion', $devisFacturesEntity->id]) ?>" target="_blank" class="btn btn-sm btn-rounded btn-primary pdf_version">Version pdf</a>
        <?php endif ?>
        <a class="btn btn-sm btn-rounded btn-primary save_model hide" data-toggle="modal" href='#model_devis_factures'><?= $devisFacturesEntity->is_model?'Enregistrer le modèle':'Enregistrer en tant que modèle' ?></a>
        <a href="javascript:void(0);" class="btn btn-sm btn-rounded btn-primary save_continuer_devis_factures <?= $devisFacturesEntity->is_model?'hide':'' ?>">Enregistrer et continuer</a>
        <a href="javascript:void(0);" class="btn btn-sm btn-rounded btn-primary save_devis_factures <?= $devisFacturesEntity->is_model?'hide':'' ?>">Enregistrer et quitter</a>
        <a href="<?= $this->Url->build(['controller' => 'DevisFactures', 'action' => 'index']) ?>" class="btn btn-sm btn-rounded btn-inverse">Annuler</a>
    </div>
<?php $this->end() ?>
...
<div class="modal fade" id="edit_client" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <?= $this->Form->create($devisFacturesEntity, ['id' => 'edit_client_form']); ?>
                <div class="modal-header">
...
<div class="modal fade" id="modal_lier_client" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <?= $this->Form->create($devisFacturesEntity, ['id' => 'lier_client']); ?>
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="">
                        <div class="row row-client">
                            <label class="col-md-3">Client : </label>
                            <div class="col-md-9">
                                <?= $this->Form->control('client_id_2', ['type' => 'select', 'empty' => 'Sélectionner', 'class' => 'js-data-client-ajax form-control', 'label' => false,'style' => 'width:100%',"data-placeholder"=>"Rechercher", 'options' => $client_2]) ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<?= $this->Form->create($devisFacturesEntity, ['class' => 'form-devis-factures']); ?>

    <?= $this->Form->hidden('uuid'); ?>
    <?= $this->Form->hidden('devis_id'); ?>
        ...
        <div class="card-body">
            ...
            <div class="row <?= $devisFacturesEntity->is_model?"hide" :"" ?>">
                ...
                <div class="offset-xl-6 offset-md-3 col-xl-3 col-md-6 col-sm-6">
                    <div class="row-fluid no-spin">
                        <?php if (!is_null($id)): ?>
                            <?= $this->Form->control('status', ['options' => $devis_factures_status, 'label' => 'Etat', 'empty' => 'Séléctionner', 'templates' => 'app_form_inline']); ?>
                        <?php endif ?>
                        <?= $this->Form->control('indent', ['label' => 'Facture N°', 'templates' => 'app_form_inline', 'default' => $indent]); ?>
                        <div class="form-group row">
                            <label class="col-md-5" for="date-crea">En date du</label><div class="col-md-7"><?= $this->Form->text('date_crea', ['type' => 'date', 'value' => $devisFacturesEntity->date_crea? $devisFacturesEntity->date_crea->format('Y-m-d') : ""]); ?></div>
                        </div>
                        <div class="form-group row hide">
                            <label class="col-md-5" for="date-sign-before">A signer avant le</label><div class="col-md-7"><?= $this->Form->text('date_sign_before', ['type' => 'date', 'value' => $devisFacturesEntity->date_sign_before? $devisFacturesEntity->date_sign_before->format('Y-m-d') : ""]); ?></div>
                        </div>
                    </div>

                    <div class="row-fluid">
                        <?= $this->Form->control('client_nom', ['label' => 'Nom du client', 'value' => $devisFacturesEntity->client->nom]); ?>
                        ...
                        <span class="clinet_info">
                            <?= $devisFacturesEntity->client_adresse ? $devisFacturesEntity->client_adresse."<br>": "" ?>
                            <?= $devisFacturesEntity->client_adresse_2? $devisFacturesEntity->client_adresse_2."<br>":"" ?>
                            <?= $devisFacturesEntity->client_cp .' '. $devisFacturesEntity->client_ville ?> <br>
                            <?= $devisFacturesEntity->client_country ?>
                        </span>

                        <div class="row-fluid mt-3">
                            <a class="d-block add-contact" data-toggle="modal" href='#edit_client'>Changer le client</a>
                            <a class="d-block add-contact" data-toggle="modal" href='#devis_factures_contact' data-href="<?= $this->Url->build(['controller' => 'AjaxDevisFactures', 'action' => 'saveCurrentContact']) ?>">Attribuer un contact</a>
                            <a class="d-block delete-contact <?= $devisFacturesEntity->facture_client_contact ? '' :'hide' ?>" href="javascript:void(0);">Supprimer le contact</a>
                        ...
                        <br>
                        <span class="clinet_info_2">
                            <?php if($devisFacturesEntity->client2) : ?>
                                Lié à <?= $devisFacturesEntity->client2->full_name ?> <br>
                            <?php endif; ?>
                        </span>
                        <div class="row-fluid">
                            <a class="d-block add-contact" data-toggle="modal" href='#modal_lier_client'>Lier à un 2ème client</a>
                            <a class="d-block delete-client-2 <?= $devisFacturesEntity->client_id_2?:"hide" ?>" href="javascript:void(0);">Supprimer le 2ème client</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="row-fluid bloc-objet">
                                <div class="form-group">
                                    <?= $this->Form->control('antennes._ids', ['class' => 'form-control select2','label' => 'Antenne(s) locale(s)', 'options' => $antennes, 'data-placeholder' => 'choisir des antennes', 'multiple'=> "multiple"]); ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="<?= $devisFacturesEntity->is_model ? "hide" :"" ?>">
                        <div class="">
                            <div class="row-fluid bloc-objet">
                                <label>Date événement</label>
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        <?= $this->Form->control('periode', ['label' => false, 'options' => ['1' => 'Le jour du', '2' => 'Période du'], 'value' => $devisFacturesEntity->date_evenement_fin?2 : 1]); ?>
                                    </div>
                                    <div class="form-group debut_evenement <?= $devisFacturesEntity->date_evenement_fin ?'col-md-4' : 'col-md-9' ?>">
                                        <?= $this->Form->text('date_evenement', ['type' => 'date', 'value' => $devisFacturesEntity->date_evenement? $devisFacturesEntity->date_evenement->format('Y-m-d') : ""]); ?>
                                    </div>
                                    <div class="m-l-15 m-r-15 m-t-10 fin_evenement <?= $devisFacturesEntity->date_evenement_fin ? '': 'hide' ?>">
                                         au 
                                    </div>
                                    <div class="form-group  col-md-4 fin_evenement <?= $devisFacturesEntity->date_evenement_fin ? '': 'hide' ?>">
                                        <?= $this->Form->text('date_evenement_fin', ['id' => 'date_evenement_fin', 'type' => 'date', 'value' => $devisFacturesEntity->date_evenement_fin? $devisFacturesEntity->date_evenement_fin->format('Y-m-d') : ""]); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="table table-uniforme table_bloc_devis_factures table-bordered  detail-form ">
                        <thead class="bg-light">
                            <tr>
                                ...
                                <th class="remise <?= ($id || $hasModel)? (!$devisFacturesEntity->remise_hide_line?:"hide"): "hide"?>"><a class="visibility-mark <?= $isInnactive = ($id || $hasModel)? (@$colVisibilityParams->remise ? 'isInnactive' : ''):"isInnactive" ?>" data="remise" href="javascript:void(0);"><span class="fa <?= $isInnactive ? 'fa-eye-slash' : 'fa-eye' ?>"></span></a> Remise</th>
                                ...
                                <?php foreach ($devisFacturesEntity->devis_factures_produits as $key => $ligne) : ?>
                                    ...
                                    <?php if($ligne->type_ligne == 'produit') : ?>
                                        <tr class="clone added-tr <?= $ligne->line_option?'ligne-option':'' ?>">
                                            ...
                                            <td><?= $this->Form->control("devis_factures_produits.$key.reference", ['input-name' => 'reference', 'label' => false, 'placeholder' => 'REF PRODUIT']); ?></td> 
                                            ...
                                            <td class="block-remise remise <?= ($id || $hasModel)? (!$devisFacturesEntity->remise_hide_line?:"hide"): "hide"?>">
                                                <div class="row">
                                                    <div class="col-6"><?= $this->Form->control("devis_factures_produits.$key.remise_value", ['input-name' => 'remise_value', 'label' => false, 'type' => 'number', 'step' => '0.01', 'class' => 'form-control', 'disabled' => ($id || $hasModel)? !$devisFacturesEntity->remise_line:true]); ?></div>
                                                    <div class="col-6"><?= $this->Form->control("devis_factures_produits.$key.remise_unity", ['input-name' => 'remise_unity', 'label' => false, 'class' => 'form-control', 'options' => ['%' => '%', '€' =>'€' ], 'disabled' => ($id || $hasModel)? !$devisFacturesEntity->remise_line:true]); ?></div>
                                                </div>
                                            </td>
                                            <td class="block-remise">
                                                ...
                                                <div class="row  ligne-for-abonnement d-none">
                                                    <div class="col-6"><?= $this->Form->control("devis_factures_produits.$key.tarif_client", ['input-name' => 'tarif_client', 'label' => false, 'type' => 'number', 'step' => '0.01', 'class' => 'form-control']); ?></div>
                                                    <div class="col-6"><?= $this->Form->control("devis_factures_produits.$key.unites_client_id", ['input-name' => 'unites_client_id', 'label' => false, 'class' => 'form-control', 'empty' => 'unité', 'options' => $catalogUnites]); ?></div>
                                                </div>
                                                
                                                <label class="m-t-10 ligne-for-abonnement d-none">TARIF INTERNE</label>
                                                <div class="row">
                                                    <div class="col-6"><?= $this->Form->control("devis_factures_produits.$key.prix_reference_ht", ['input-name' => 'prix_reference_ht', 'label' => false, 'type' => 'number', 'step' => '0.01', 'class' => 'form-control']); ?></div>
                                                    <div class="col-6"><?= $this->Form->control("devis_factures_produits.$key.catalog_unites_id", ['input-name' => 'catalog_unites_id', 'label' => false, 'class' => 'form-control', 'empty' => 'unité']); ?></div>
                                                </div>
                                            </td>
                                            <td>
                                                <label class="ligne-for-abonnement d-none label-for-abonnement"> -</label>
                                                <div class="row ligne-for-abonnement d-none">
                                                    <div class="col-12"><?= $this->Form->control("devis_factures_produits.$key.tva_client", ['type' => 'select', 'options' => $tvas, 'input-name' => 'tva_client', 'label' => false, 'class'=>"form-control tva-value"]); ?></div>
                                                </div>
                                                <label class="m-t-10 ligne-for-abonnement d-none label-for-abonnement"> -</label>
                                                <div class="row">
                                                    <div class="col-12"><?= $this->Form->control("devis_factures_produits.$key.tva", ['type' => 'select', 'options' => $tvas, 'input-name' => 'tva', 'label' => false, 'class'=>"form-control tva-value"]); ?></div>
                                                </div>
                                            </td>
                                            <td>
                                                <label class="ligne-for-abonnement d-none label-for-abonnement"> -</label>
                                                <div class="row ligne-for-abonnement d-none">
                                                    <div class="col-12"><?= $this->Form->control("devis_factures_produits.$key.quantite_client", ['input-name' => 'quantite_client', 'label' => false, 'type' => 'number']); ?></div>
                                                </div>
                                                <label class="m-t-10 ligne-for-abonnement d-none label-for-abonnement"> -</label>
                                                <div class="row">
                                                    <div class="col-12"><?= $this->Form->control("devis_factures_produits.$key.quantite_usuelle", ['input-name' => 'quantite_usuelle', 'label' => false, 'type' => 'number']); ?></div>
                                                </div>
                                                <?= $this->Form->hidden("devis_factures_produits.$key.type_ligne", ['input-name' => 'type_ligne', 'value' => 'produit']); ?>
                                            </td>
                                            <td class="montant_ht text-right">
                                                <label class="ligne-for-abonnement d-none label-for-abonnement"> -</label>
                                                <div class="row ligne-for-abonnement d-none">
                                                    <div class="col-12"><div class="montant_ht_client"><?= $ligne->montant_client ?></div></div>
                                                    <?= $this->Form->hidden("devis_factures_produits.$key.montant_client", ['input-name' => 'montant_client']); ?>
                                                </div>
                                            ...
                                            <td class="text-center">
                                                <a href="javascript:void(0);" data-href="<?= $this->Url->build(['controller' => 'AjaxDevisFactures', 'action' => 'deleteLineDevisFacturesProduit',$ligne->id]) ?>" id="remove-prod"><i class="mdi mdi-delete text-inverse"></i></a>
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                    ...
                                    <?php if($ligne->type_ligne == 'abonnement') : ?>
                                        <tr class="clone added-tr <?= $ligne->line_option?'ligne-option':'' ?>">
                                            ...
                                            <td>
                                                ...
                                                <?= $this->Form->hidden("devis_factures_produits.$key.type_ligne", ['input-name' => 'type_ligne', 'value' => 'abonnement']); ?>
                                            </td>
                                            <td class="montant_ht text-right">
                                                <label class="ligne-for-abonnement label-for-abonnement"> -</label>
                                                <div class="row ligne-for-abonnement">
                        ...
                        <tfoot>
                            <tr class="clone d-none added-tr">
                                <td class=""><?= $this->fetch('td_options') ?></td>
                                <td class="d-none">
                                    <?= $this->Form->hidden("devis_factures_produits.catalog_produits_id", ['input-name' => 'catalog_produits_id', 'label' => false]); ?>
                                    <?= $this->Form->hidden("devis_factures_produits.i_position", ['input-name' => 'i_position', 'label' => false, 'class' => 'i-position']); ?>
                                    <?= $this->Form->hidden("devis_factures_produits.line_option", ['input-name' => 'line_option', 'label' => false, 'class' => '']); ?>
                                </td>
                                <td><?= $this->Form->control("devis_factures_produits.reference", ['input-name' => 'reference', 'label' => false, 'placeholder' => 'REF PRODUIT']); ?></td> 
                                <td class="p-0"><?= $this->Form->control("devis_factures_produits.description_commercial", ['input-name' => 'description_commercial', 'label' => false, 'class' => '', 'type' => 'textarea', 'id' => '']); ?> </td>
                                <td class="block-remise remise <?= ($id || $hasModel)? (!$devisFacturesEntity->remise_hide_line?:"hide"): "hide"?>">
                                    <div class="row">
                                        <div class="col-6"><?= $this->Form->control("devis_factures_produits.remise_value", ['input-name' => 'remise_value', 'label' => false, 'type' => 'number', 'step' => '0.01', 'class' => 'form-control', 'disabled' => ($id || $hasModel)? !$devisFacturesEntity->remise_line:true]); ?></div>
                                        <div class="col-6"><?= $this->Form->control("devis_factures_produits.remise_unity", ['input-name' => 'remise_unity', 'label' => false, 'class' => 'form-control', 'options' => ['%' => '%', '€' =>'€' ], 'disabled' => ($id || $hasModel)? !$devisFacturesEntity->remise_line:true]); ?></div>
                                    </div>
                                </td>
                                <td class="block-remise">
                                    ...
                                    <label class="ligne-for-abonnement d-none">TARIF CLIENT</label>
                                    <div class="row ligne-for-abonnement d-none">
                                        <div class="col-6"><?= $this->Form->control("devis_factures_produits.tarif_client", ['input-name' => 'tarif_client', 'label' => false, 'type' => 'number', 'step' => '0.01', 'class' => 'form-control']); ?></div>
                                        <div class="col-6"><?= $this->Form->control("devis_factures_produits.unites_client_id", ['input-name' => 'unites_client_id', 'label' => false, 'class' => 'form-control', 'empty' => 'unité', 'options' => $catalogUnites]); ?></div>
                                    </div>

                                    <label class="m-t-10 ligne-for-abonnement d-none">TARIF INTERNE</label>
                                    <div class="row">
                                        <div class="col-6"><?= $this->Form->control("devis_factures_produits.prix_reference_ht", ['input-name' => 'prix_reference_ht', 'label' => false, 'type' => 'number', 'step' => '0.01', 'class' => 'form-control']); ?></div>
                                        <div class="col-6"><?= $this->Form->control("devis_factures_produits.catalog_unites_id", ['input-name' => 'catalog_unites_id', 'label' => false, 'class' => 'form-control', 'empty' => 'unité']); ?></div>
                                    </div>
                                </td>
                                <td>
                                    <label class="ligne-for-abonnement label-for-abonnement d-none"> -</label>
                                    <div class="row ligne-for-abonnement d-none">
                                        <div class="col-12"><?= $this->Form->control("devis_factures_produits.tva_client", ['type' => 'select', 'options' => $tvas, 'input-name' => 'tva_client', 'label' => false, 'default' => $defaultTva->valeur, 'class'=>"form-control tva-value"]); ?></div>
                                    </div>
                                    <label class="m-t-10 ligne-for-abonnement label-for-abonnement d-none"> -</label>
                                    <div class="row">
                                        <div class="col-12"><?= $this->Form->control("devis_factures_produits.tva", ['type' => 'select', 'options' => $tvas, 'input-name' => 'tva', 'label' => false, 'default' => $defaultTva->valeur, 'class'=>"form-control tva-value"]); ?></div>
                                    </div>
                                </td>
                                <td>
                                    <label class="ligne-for-abonnement label-for-abonnement d-none"> -</label>
                                    <div class="row ligne-for-abonnement d-none">
                                        <div class="col-12"><?= $this->Form->control("devis_factures_produits.quantite_client", ['input-name' => 'quantite_client', 'label' => false, 'type' => 'number', 'default' => 1]); ?></div>
                                    </div>
                                    <label class="m-t-10 ligne-for-abonnement label-for-abonnement d-none"> -</label>
                                    <div class="row">
                                        <div class="col-12"><?= $this->Form->control("devis_factures_produits.quantite_usuelle", ['input-name' => 'quantite_usuelle', 'label' => false, 'type' => 'number', 'default' => 1]); ?></div>
                                    </div>
                                    <?= $this->Form->hidden("devis_factures_produits.type_ligne", ['input-name' => 'type_ligne', 'value' => 'produit']); ?>
                                </td>
                                <td class="montant_ht text-right">
                                    <label class="ligne-for-abonnement label-for-abonnement d-none"> -</label>
                                    <div class="row ligne-for-abonnement d-none">
                            ...
                            <tr class="clone-new-abonnement added-tr d-none">
                                ...
                                <td>
                                    ...
                                    <?= $this->Form->hidden("devis_factures_produits.type_ligne", ['input-name' => 'type_ligne', 'value' => 'abonnement']); ?>
                                </td>
                                <td class="montant_ht text-right">
                                    <label class="ligne-for-abonnement label-for-abonnement "> -</label>
                                    <div class="row ligne-for-abonnement ">
                            ...
                            <tr class="clone-sous-total d-none">
                                ...
                                <td class="d-none"><?= $this->Form->hidden("devis_factures_produits.i_position", ['input-name' => 'i_position', 'label' => false, 'class' => 'i-position']); ?></td>
                                <td colspan="5" class="bg-light dynamic-colspan">
                                    <div class="text-center"> <h4>Sous-total</h4></div>
                                    <?= $this->Form->hidden('devis_factures_produits.sous_total', ['input-name' => 'sous_total', 'label' => false, ]); ?>
                                    <?= $this->Form->hidden('devis_factures_produits.type_ligne', ['input-name' => 'type_ligne', 'value' => 'sous_total']); ?>
                                </td>
                                <td class="montant_ht text-right">
                                    <div class="row">
                            ...
                            <tr class="clone-titre d-none">
                                ...
                                <td class="d-none"><?= $this->Form->hidden("devis_factures_produits.i_position", ['input-name' => 'i_position', 'label' => false, 'class' => 'i-position']); ?></td>
                                <td colspan="6" class="p-0 dynamic-colspan">
                                    <?= $this->Form->control('devis_factures_produits.titre_ligne', ['input-name' => 'titre_ligne', 'label' => false, 'type' => 'textarea', 'id' => '']); ?>
                                    <?= $this->Form->hidden('devis_factures_produits.type_ligne', ['input-name' => 'type_ligne', 'value' => 'titre']); ?>
                                    </td>
                                <td class="text-center"><a href="javascript:void(0);" id="remove-prod"><i class="mdi mdi-delete text-inverse"></i></a></td>
                            </tr>
                            ...
                            <tr class="clone-commentaire d-none">
                                ...
                                <td class="d-none"><?= $this->Form->hidden("devis_factures_produits.i_position", ['input-name' => 'i_position', 'label' => false, 'class' => 'i-position']); ?></td>
                                <td colspan="6" class="p-0 dynamic-colspan">
                                    <?= $this->Form->control('devis_factures_produits.commentaire_ligne', ['input-name' => 'commentaire_ligne', 'label' => false, 'type' => 'textarea', 'id' => '']); ?>
                                    <?= $this->Form->hidden('devis_factures_produits.type_ligne', ['input-name' => 'type_ligne', 'value' => 'commentaire']); ?>
                                    </td>
                                <td class="text-center"><a href="javascript:void(0);" id="remove-prod"><i class="mdi mdi-delete text-inverse"></i></a></td>
                            </tr>
                            ...
                            <tr class="clone-saut-ligne d-none">
                                ...
                                <td colspan="6" class="bg-light dynamic-colspan">
                                    <div class="text-center"> <h4>Saut de ligne</h4></div>
                                    <?= $this->Form->hidden('devis_factures_produits.type_ligne', ['input-name' => 'type_ligne', 'label' => false, 'value' => 'saut_ligne']); ?>
                                </td>
                                <td class="text-center"><a href="javascript:void(0);" id="remove-prod"><i class="mdi mdi-delete text-inverse"></i></a></td>
                            </tr>
                            ...
                            <tr class="clone-saut-page d-none">
                                ...
                                <td colspan="6" class="bg-light dynamic-colspan">
                                    <div class="text-center"> <h4>Saut de page</h4></div>
                                    <?= $this->Form->hidden('devis_factures_produits.type_ligne', ['input-name' => 'type_ligne', 'label' => false, 'value' => 'saut_page']); ?>
                                </td>
                                <td class="text-center"><a href="javascript:void(0);" id="remove-prod"><i class="mdi mdi-delete text-inverse"></i></a></td>
                            </tr>
                        </tfoot>
                ...
                <div class="col-md-6">
                    <table class="table table-uniforme  total-avec-abonnement d-none">
                        ...
                        <tbody>
                            ...
                            <tr  class="total-remise-global <?= ($id || $hasModel)? (!$devisFacturesEntity->remise_line?:"hide"): ""?>">
                                <td>Réduction HT</td>
                        ...
                        <div class="tab-content pt-4" id="my-tab">
                            <div class="tab-pane fade show active" id="infospaiement" role="tabpanel" aria-labelledby="infospaiement-tab">
                                <div class="row">
                                    <?php foreach ($moyen_reglements as $key => $moyen_reglement): ?>
                                        <div class="col-md-3">
                                            <?= $this->Form->control("moyen_reglements[$key]", ['type' => 'checkbox', 'label' => $moyen_reglement, 'checked' => $devisFacturesEntity->moyen_reglements[$key] == 1 ? 'checked' : '']); ?>
                                        </div>
                                    <?php endforeach ?>
                                </div>
                                ...
                                <div class="row div-echeance <?= $devisFacturesEntity->delai_reglements == 'echeances'?'':'hide' ?>">
                                    <div  class="col-md-2">
                                    ...
                                    <div  class="col-md-5">
                                        ...
                                        <table id="echeance" class="mb-0 table mt-4 table-bordered table-uniforme">
                                            ...
                                            <tbody class="echeance">
                                                <?php if($devisFacturesEntity->devis_factures_echeances) : ?>
                                                    <?php foreach ($devisFacturesEntity->devis_factures_echeances as $key => $echeance) : ?>
                                                        <tr class="<?= $echeance->is_payed ? "is_payed" : "" ?>" date="<?= $echeance->date ? $echeance->date->format('Y-m-d'):"" ?>" montant="<?= $echeance->montant ?>">
                                                            <td>
                                                                <?= $this->Form->hidden("devis_factures_echeances.$key.id", ['input-name' => 'id',  'class' => '', 'label' => false, ]); ?>
                                                                <?= $this->Form->text("devis_factures_echeances.$key.date", ['input-name' => 'date',  'class' => 'form-control echeance-date', 'label' => false, 'type' => 'date', 'value' => $echeance->date?$echeance->date->format('Y-m-d'):""]); ?>
                                                            </td>
                                                            <td>
                                                                <?= $this->Form->control("devis_factures_echeances.$key.montant", ['input-name' => 'montant', 'type' => 'number', 'step' => '0.01', 'class' => 'form-control echeance-montant', 'label' => false]); ?>
                                                            </td>
                                                            <td>
                                        ...
                                        <table class="table hide-table-empty table-uniforme">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td colspan="2"><div class="ml-3 total_echeances"> <?= $devisFacturesEntity->get('TotalEcheances') ?></div></td>
                                                </tr>
                                                <tr>
                                                    <td><b>Reste</b></td>
                                                    <td colspan="2"> <div class="ml-3 rest_echeances"><?= $devisFacturesEntity->get('ResteEcheanceMontant') ?></div></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="clearfix container-infos-bq <?= $devisFacturesEntity->display_virement ?: 'd-none' ?>">
                                    <div class="row">
                                        <div class="col-1">
                                            <b>Banque :</b>
                                        </div>
                                        <div class="col-10 p-0">
                                            <p class="mb-4 infos-bq-ajax">
                                                <?= $devisFacturesEntity->infos_bancaire?$devisFacturesEntity->infos_bancaire->adress:"" ?> <br>
                                                BIC : <?= $devisFacturesEntity->infos_bancaire?$devisFacturesEntity->infos_bancaire->bic:"" ?> <br>
                                                IBAN : <?= $devisFacturesEntity->infos_bancaire?$devisFacturesEntity->infos_bancaire->iban:"" ?>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container-libelle mb-4 <?= $devisFacturesEntity->display_cheque ?: 'd-none' ?>"><b>KONITYS</b></div>
                            ...
                            <div class="tab-pane fade" id="remise&accompte" role="tabpanel" aria-labelledby="remise&accompte-tab">
                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <?= $this->Form->control('remise_global_value', ['label' => false, 'type' => 'number', 'class' => 'remise-global form-control', 'default'=>'0', 'disabled' => ($id || $hasModel)? $devisFacturesEntity->remise_line:false]) ?>
                                        </div>
                                        <div class="col-md-2">
                                            <?= $this->Form->control('remise_global_unity', ['label' => false, 'options' => ['%' => '%', '€' =>'€' ], 'class' => 'remise-global form-control', 'disabled' => ($id || $hasModel)? $devisFacturesEntity->remise_line:false]) ?>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="col-md-5 align-self-center">
                                        <div class="mt-1"><?= $this->Form->control('remise_line', ['type' => 'checkbox', 'class' => 'selectpicker', 'label' => 'Remise par ligne', 'checked' => ($id || $hasModel)? $devisFacturesEntity->remise_line:false]); ?></div>
                                    </div>
                                    <div class="col-md-5 align-self-center">
                                        <div class="mt-1"><?= $this->Form->control('remise_hide_line', ['type' => 'checkbox','label' => 'Masquer la colone "Remise"', 'class' => "remise-hide-line form-control", 'checked' => ($id || $hasModel)? $devisFacturesEntity->remise_hide_line:true]); ?></div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="affichage" role="tabpanel" aria-labelledby="affichage-tab">
                                ...
                                <div class="row row-client m-t-12">
                                    ...
                                    <div class="col-md-6">
                                        <?= $this->Form->control('categorie_tarifaire', ['options' => $categorie_tarifaires, 'label' => false, 'empty' => 'Catégorie tarifaire']); ?>
                                    </div>
                                </div>
                                <div class="row row-client m-t-12">
                                    <div class="col-md-2 m-t-10">
    ...
    <div class="modal fade" id="model_devis_factures" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <?= $this->Form->hidden('new_model',['id' => 'is_model', 'value' => $devisFacturesEntity->is_model && $id ? 0:1]); ?>
                    <?= $this->Form->control('model_name',['label' => 'Nom du modele']); ?>
                    <?= $this->Form->control('modele_devis_factures_category_id', ['label' => 'Catégorie','options' => $modelDevisFacturesCategorie, 'empty' => 'Catégorie']); ?>
                    <?= $this->Form->control('modele_devis_factures_sous_category_id', ['label' => 'Sous catégorie', 'options' => [], 'empty' => 'Sous catégorie']); ?>
                    <?= $this->Form->hidden('modele_devis_factures_sous_category_id', ['id' => 'sCatId', 'name' => 'sCatId']); ?>
                           
                    <div class="form-group <?= $devisFacturesEntity->is_model? "hide" : "" ?>">
                        <label>Paramètres de préférences du document </label>
                        <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="preference1" name="parametre_preference" value="1" checked>
                        ...
                        <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="preference2" value="0" name="parametre_preference">
...
<script type="text/javascript">
    var modelDevisFacturesSousCategorie = <?php echo json_encode($modelDevisFacturesSousCategorie); ?>;
</script>
