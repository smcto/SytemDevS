<?php 
    //debug($devis);
    $titrePage = "Historique devis :".$devis->indent ;
...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
                <div class="card-body">
                    <h3 class="card-title">DEVIS : <?= $devis->indent ?></h3>
                    <hr>
                    <div class="form-group row">
                        <label class="control-label col-md-6">Date de création : </label>
                        <div class="col-md-6 ">
                            <?= $devis->created ? $devis->created->format('d/m/Y H:i'):"" ?>
                        </div>
                        <label class="control-label col-md-6">Statut : </label>
                        <div class="col-md-6">
                            <?= @$facture_status[$devis->status] ?>
                        </div>
    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                <div class="related">
                    <?php if (!empty($devis->statut_historiques)){ ?>
                    <table class="table table-striped" >
                        ...
                        <?php foreach ($devis->statut_historiques as $historique) { ?>
                        <tr>
                            <td><?= h(@$facture_status[$historique->statut_document]) ?></td>
