...
<?php $this->start('bloc_btn') ?>
    <div class="float-right">
        ...
        <a href="<?= $this->Url->build(['controller' => 'Devis', 'action' => 'view', $devi_id]) ?>" class="btn btn-sm btn-rounded btn-inverse">Annuler</a>
    </div>
<?php $this->end() ?>
...
<?= $this->Form->create($factureSituationEntity, ['class' => 'form-facture-situation']); ?>
    ...
    <?= $this->Form->hidden('devi_id', ['value' => $devi_id]); ?>
                                    ...
                                    <?php if($ligne->type_ligne == 'produit' || $ligne->type_ligne == 'abonnement') : ?>
                                        <tr class="clone added-tr <?= $ligne->line_option?'ligne-option':'' ?>">
                                            <td class="d-none">
                                                ...
                                                <?= $this->Form->hidden("facture_situations_produits.$key.catalog_produits_id", ['input-name' => 'catalog_produits_id', 'label' => false]); ?>
                                                <?= $this->Form->hidden("facture_situations_produits.$key.i_position", ['input-name' => 'i_position', 'label' => false, 'class' => 'i-position']); ?>
                                                <?= $this->Form->hidden("facture_situations_produits.$key.line_option", ['input-name' => 'line_option', 'label' => false, 'class' => '']); ?>
                                                <?= $this->Form->hidden("facture_situations_produits.$key.type_ligne", ['input-name' => 'type_ligne', 'value' => 'sous_total']); ?>
                                            </td>
                                            <td>
                                                <?= $ligne-> reference ?>
                                                <?= $this->Form->hidden("facture_situations_produits.$key.reference", ['input-name' => 'reference', 'label' => false]); ?>
                                            </td> 
                                            <td class="p-0"><?= $this->Form->control("facture_situations_produits.$key.description_commercial", ['input-name' => 'description_commercial', 'label' => false, 'class' => 'tinymce-note', 'type' => 'textarea']); ?> </td>
                                            <td class="block-remise remise">
                                                <div class="col-12"><?= $ligne->remise_value . $ligne->remise_unity ?></div>
                                                <?= $this->Form->hidden("facture_situations_produits.$key.remise_value", ['input-name' => 'remise_value', 'label' => false, 'type' => 'number']); ?>
                                                <?= $this->Form->hidden("facture_situations_produits.$key.remise_unity", ['input-name' => 'remise_unity']); ?>
                                                <?= $this->Form->hidden("facture_situations_produits.$key.remise_euro", ['input-name' => 'remise_euro', 'class' => 'remise_euro']); ?>
                                            </td>
                                            <td class="block-remise">
                                                <div class="col-12"><?= $ligne->prix_reference_ht ?></div>
                                                <?= $this->Form->hidden("facture_situations_produits.$key.prix_reference_ht", ['input-name' => 'prix_reference_ht', 'label' => false,]); ?>
                                            </td>
                                            <td class="text-right">
                                                <div class="col-12">
                                                    <div class="facture_pourcent"><?= $ligne->facture_pourcentage? : 0 ?> %</div>
                                                    <?= $this->Form->hidden("facture_situations_produits.$key.facture_pourcentage", ['input-name' => 'facture_pourcentage', 'label' => false,]); ?>
                                                    <div class="facture_euro m-t-30"><?= $ligne->facture_euro? : 0 ?> €</div>
                                                    <?= $this->Form->hidden("facture_situations_produits.$key.facture_euro", ['input-name' => 'facture_euro', 'label' => false,]); ?>
                                                    <div class="quantite_usuelle  m-t-30"><?= $ligne->quantite_usuelle ?></div>
                                                    <?= $this->Form->hidden("facture_situations_produits.$key.quantite_usuelle", ['input-name' => 'quantite_usuelle', 'label' => false,]); ?>
                                                </div>
                                                <?= $this->Form->hidden("facture_situations_produits.$key.facture_prevu_value", ['input-name' => 'facture_prevu_value', 'label' => false]); ?>
                                                <?= $this->Form->hidden("facture_situations_produits.$key.facture_prevu_unity", ['input-name' => 'facture_prevu_unity', 'label' => false]); ?>
                                            </td>
                                            <td class="text-right">
                                                <div class="col-12">
                                                    <div class="row m-l-10"><?= $this->Form->control("facture_situations_produits.$key.avancement_pourcentage", ['input-name' => 'avancement_pourcentage', 'label' => false, 'type' => 'number', 'step' => '0.01', 'class' => 'form-control avancement_pourcentage']); ?><span class="suffix">%</span></div>
                                                    <div class="row m-l-10"><?= $this->Form->control("facture_situations_produits.$key.avancement_euro", ['input-name' => 'avancement_euro', 'label' => false, 'type' => 'number', 'step' => '0.01', 'class' => 'form-control avancement_euro']); ?><span class="suffix">€</span></div>
                                                    <?= $this->Form->hidden("facture_situations_produits.$key.avancement_quantite", ['input-name' => 'avancement_quantite', 'label' => false, 'class' => 'avancement_quantite']); ?>
                                                    <div class="quantite_avancement  m-t-20 m-r-20"><?= $ligne->avancement_quantite ?></div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="col-12"><?= $ligne->tva ?>%</div>
                                                <?= $this->Form->hidden("facture_situations_produits.$key.tva", ['input-name' => 'tva', 'label' => false]); ?>
                                            </td>
                                            <td class="montant_ht text-right">
                                                <div class="col-12">
                                                    <div class="montant_ht_value">0</div>
                                                    <?= $this->Form->hidden("facture_situations_produits.$key.montant_ht", ['input-name' => 'montant_ht', 'label' => false]); ?>
                                                </div>
                                            </td>
                                            <td class="montant_ttc text-right">
                                                <div class="col-12">
                                                    <div class="montant_ttc_value">0</div>
                                                    <?= $this->Form->hidden("facture_situations_produits.$key.montant_ttc", ['input-name' => 'montant_ttc', 'label' => false]); ?>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endif; ?>
