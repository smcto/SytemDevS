...
<!--<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $pipe->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $pipe->id)]
            )
        ?></li>
...
<div class="pipes form large-9 medium-8 columns content">
    <?= $this->Form->create($pipe) ?>
    <fieldset>
        <legend><?= __('Edit Pipe') ?></legend>
        <?php
