...
<div class="typeAnimations view large-9 medium-8 columns content">
    ...
    <div class="row">
        ...
        <?= $this->Text->autoParagraph(h($typeAnimation->description)); ?>
    </div>
    <div class="related">
        <h4><?= __('Related Evenements') ?></h4>
        <?php if (!empty($typeAnimation->evenements)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($typeAnimation->evenements as $evenements): ?>
            <tr>
                ...
                <td><?= h($evenements->type_animation_id) ?></td>
                <td><?= h($evenements->antenne_id) ?></td>
                <td><?= h($evenements->user_id) ?></td>
                <td class="actions">
