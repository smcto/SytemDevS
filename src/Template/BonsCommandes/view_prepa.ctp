...
echo $this->Html->link(__('Modifier') ,['action'=>'edit', $bonsCommande->id],['escape'=>false,"class"=>"btn pull-right btn-rounded hidden-sm-down btn-success" ]);
echo $this->Html->link(__('Imprimer') ,['action'=>'pdfversion', $bonsCommande->id, 'forceGenerate' => 1],['escape'=>false,"class"=>"btn pull-right btn-rounded hidden-sm-down btn-success m-r-5" ]);
if ($bonsCommande->statut != 'en_attente') {
    echo $this->Form->postLink(__('Générer le Bon de Livraison '), ['controller' => 'BonsLivraisons', 'action'=>'createBlFromBc', $bonsCommande->id], 
        ['confirm' => $bonsCommande->statut == 'en_prepa' ? __('Attention, la commande est incomplète, êtes-vous sur de vouloir générer le BL ?') : false,
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="row col-6">
                        ...
                        <div class="col-md-8"> <?= $bonsCommande->date_depart_atelier?$bonsCommande->date_depart_atelier->format('d-m-Y') : '' ?></div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="<?= $bonsCommande->bons_commande_id ? : 'hide' ?>">Restant à expédier </th>
                            ...
                            <?php foreach ($bonsCommande->bons_commandes_produits as $key => $produit): 
                            ...
                            <tr class="tr-<?=$produit->statut ?>">
                                ...
                                <td class="text-center <?= $bonsCommande->bons_commande_id ? : 'hide' ?>">
                    ...
                    <div class="row m-t-40">
                        <div class="col-md-8">
                            ...
                            <div class="row col-6">
                                ...
                                <div class="col-md-6"><?= $bonsCommande->nombre_palettes ?> </div>
                            </div>
                            <div class="row col-6">
                                <label for="" class="col-md-6">Nombre de carton(s) : </label>
                                <div class="col-md-6"><?= $bonsCommande->nombre_cartons ?> </div>
                            </div>
                            <div class="row col-6">
                                <label for="" class="col-md-6">Poids : </label>
                                <div class="col-md-6"><?= $bonsCommande->poids ?> </div>
                            </div>
                        </div>
