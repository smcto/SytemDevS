...
<?= $this->Html->css('daterangepicker/daterangepicker.css',['block'=>true]) ?>
...
<?php
$titrePage = "Ajout d'un nouveau événement";
        ...
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                ...
                <div class="form-body">
                    ...
                    <div class="row p-t-20">
                        ...
                        <div class="col-md-4 bloc-client">
                            ...
                            <?php echo $this->Form->control('client_id',['label' =>false, 'class'=>'form-control select2', 'empty'=>'Séléctionner d\'abord un type de client', 'id'=>'clients_id','disabled' => true]); ?>
                        </div>

                        <div class="col-md-4 envoyer_recap hide"><br>
                    ...
                    <div class="row p-t-20">
                        ...
                        <div class="col-md-6">
                            <?php echo $this->Form->control('nature_evenement_id',['id'=>'natureEvenement_id','label' => 'Nature de l\'évenement *', 'options'=>$natureEvenements,'empty'=>'Séléctionner', 'disabled' => true]); ?>
                        </div>
                    </div>
                        <div class="row p-t-20">
                        <div class="col-md-6">
                    ...
                    <div class="row p-t-20">
                        ...
                        <div class="col-md-3">
                            ...
                            <?php echo $this->Form->control('borne_id',['label' =>false, 'class'=>'form-control select2', 'data-live-search'=>'true', 'empty'=>'Séléctionner', 'disabled' => true, 'id'=>'borne_id']); ?>
                        </div>
                        <!--/span-->
                        <div class="col-md-3">
                    ...
                    <!--<div class="row p-t-20 blocDateplanning" id="blocDateEvenement-0">
                        <label class="control-label col-sm-2">Date * :</label>
                        <div class="input-group kl_date_block_large">
                            <input type="text" class="form-control date_evenenement" required="required" id="dateevenement-0"/>
                            <span class="input-group-addon add-on kl_date_clickpicker kl_daterange_iconPicker"></span>
                            <span class="btn kl_suppr_date" id="btnSupprDate-0"></span>
                            <?php echo $this->Form->control('date_evenements.0.date_debut',["type"=>"hidden", "id"=>"date_debut-0"])?>
                            <?php echo $this->Form->control('date_evenements.0.date_fin',["type"=>"hidden", "id"=>"date_fin-0"])?>
                        </div>
                    ...
                    <div class="row p-t-20">
                        <div class="col-md-6">
                            <label class="control-label">Date debut</label>
                            <input type="date" name="date_debut_immobilisation" id="date_debut_immobilisation" class="form-control" placeholder="dd/mm/yyyy">
                        </div>
                        <div class="col-md-6">
                            <label class="control-label">Date fin</label>
                            <input type="date" name="date_fin_immobilisation" id="date_fin_immobilisation" class="form-control" placeholder="dd/mm/yyyy">
                        </div>
                        <!--/span-->
                    </div>
                    <hr>
                    ...
                    <div class="row p-t-20">
                        ...
                        <div class="col-md-6 hide" id="id_personne_affecte">
                            <?php
                    ...
                    <div class="row p-t-20">
                        ...
                        <div class="col-md-6 hide" id="id_personne_affecte_desinstallation">
                            <?php
                    ...
                    <div class="row p-t-20">
                        <div class="col-md-4 bloc-type-client">
                            <?php echo $this->Form->control('responsable_id',['label' => 'Responsable de projet ', 'class'=>'form-control select2', 'options'=>$responsablesList,'empty'=>'Séléctionner']); ?>
                        </div>
                        <div class="col-md-4 bloc-client">
                ...
                <div class="form-actions">
                    ...
                    <!--<?= $this->Form->button('Cancel',["type"=>"reset", "class"=>"btn btn-rounded btn-inverse btn_cancel",'escape'=>false]) ?>-->
                </div>
                <?= $this->Form->end() ?>
            </div>
        </div>
