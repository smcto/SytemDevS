 ...
 * @var \App\Model\Entity\CatalogCategory $catalogCategory
 */
?>
<?php
    $this->assign('title', 'Categorie');
    $titrePage = "Ajouter une nouvelle categorie" ;
    if ($id) {
        $titrePage = "Modification d'une categorie" ;
    }
    ...
    $this->Breadcrumbs->add(
        'Catalogue catégorie',
        ['controller' => 'CatalogCategories', 'action' => 'index']
    );
...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                <?= $this->Form->create($catalogCategory) ?>
                    <div class="form-body">
                        <div class="row">
                            <div class="col-sm-6">
