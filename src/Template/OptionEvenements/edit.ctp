...
<?php
$titrePage = "Modifier option évenement " ;
...
<!--<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $optionEvenement->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $optionEvenement->id)]
            )
        ?></li>
...
<div class="optionEvenements form large-9 medium-8 columns content">
    <?= $this->Form->create($optionEvenement) ?>
    <fieldset>
        <legend><?= __('Edit Option Evenement') ?></legend>
        <?php
