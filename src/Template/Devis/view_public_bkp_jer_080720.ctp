...
<div class="quotation-container">
    ...
    <div class="quotation-header-wrapper">
        ...
        <div class="left-quotation-header-wrapper">
            ...
            <div class="inner-left-header-wrapper">
                ...
                <div class="right-header-detail-wrapper">
                    ...
                    <div>
                        ...
                        <div class="hide-for-mobile">
                            Contact : <?= $devisEntity->client->get('FullName') ?>
                        </div>
                        <div class="hide-for-mobile">
                ...
                <div class="header-booking-button-block">
                    ...
                    <div class="quotation-button">
                        ...
                        <div class="outer-bottom-text">
                            En réglant aujourd'hui l'acompte de 117 &euro;
                        </div>
    ...
    <div class="quotation-main-content-container">
                ...
                <div class="booking-step-container booking-step-one">
                    ...
                    <div class="booking-detail-container">
                        ...
                        <div class="booking-instruction-wrapper">
                            ...
                            <div class="outer-instruction-container">
                                ...
                                <div class="instruction-block">
                                    ...
                                    <div class="indication-text">
                                        ...
                                        <p>
                                            Certains confrères proposent des bornes qui impriment en 45 secondes. Le rendu photo de ces imprimantes est peu qualitatif et vous allez de plus devoir recharger très souvent la bobine de papier.
                                        </p>
                                        <p>
                                ...
                                <div class="instruction-block">
                                    ...
                                    <div class="indication-text">
                                        ...
                                        <p>
                                            Profitez pleinement de la borne pendant tout votre événement. Au lieu de vous louer la borne que le samedi, nous préférons vous offrir la location du dimanche en l’incluant dans le tarif.
                                        </p>
                            ...
                            <div class="bottom-indication-wrap hide-for-mobile">

                                <p>
                                    <span class="bold">Réglez uniquement un acompte de 117 &euro; aujourd'hui pour bloquer votre date !</span> Notre équipe prendre contact avec vous par la suite pour la mise en place de notre animation.
                                </p>
                    ...
                    <div class="booking-detail-container">
                                            ...
                                            <div class="booking-info-wrap top-booking-info-wrap">
                                                <div class="booking-type to-pay-type bold">
                                                    ...
                                                    <?php if ($echeance->is_payed == 0): ?>
                                                        ...
                                                        <label for="echeance-<?= $echeance->id ?>" class="text-success">À régler</label>
                                                    <?php else: ?>
                                                ...
                                                <div class="booking-amount medium-bold darker-gray-text">
                                                    <?= $this->Number->currency($echeance->montant, 'EUR'); ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="booking-info-wrap">
                                            <div class="medium-bold darker-gray-text">
                                                <?php if ($devisEntity->status != 'paid'): ?>
                                                    ...
                                                    <label for="echeance-total_remaining">Payer la totalité du document</label>
                                                <?php else: ?>
                                                    <label for="echeance-total_remaining">Document payé</label>
                                                <?php endif ?>
                                            </div>
                                            <div class="booking-amount medium-bold darker-gray-text">
                        ...
                        <div class="booking-condition-block">
                            ...
                            <p class="cgl-err text-danger d-none">
                                Vous devez accepter les conditions de vente avant de procéder au paiement.
                            </p>
                        ...
                        <div class="bottom-payment-choice-wrapper">
        ...
        <div class="quotation-side-section quotation-document-section">
            ...
            <div class="document-preview-wrapper book-preview-wrapper">
                ...
                <!--<iframe src="https://www.selfizee.fr/docs/brochure-selfizee-classik.pdf" class="booth-type-container"></iframe>-->

                <iframe src="https://www.selfizee.fr/docs/brochure-selfizee-spherik.pdf" class="booth-type-container"></iframe>

            </div>

            <div class="bottom-button-block hide-for-mobile">
    ...
    <div class="trutpilot-wrapper hide-for-mobile">
...
<div class="popup-container payment-popup-container container-stripe-form" id="stripe-container">
    ...
    <div class="inner-popup-container stripe-modal customized-scrollbar stripe-modal" data-client-public="<?= $stripeApiKeyPublic ?>">
        ...
        <?= $this->Form->create($devisEntity, ['url' => ['action' => 'makePayment', $param], 'class' => 'form-payment']); ?>

            <div class="popup-selfizee-logo">
                <?php echo $this->Html->image('logo-selfizee.png', ['alt' => 'Logo', "class" => ""]); ?>
            </div>
