...
<div class="quotation-container">
                    ...
                    <div class="header-booking-button-block">
                            ...
                            <div class="quotation-button">
                                ...
                                <div class="outer-bottom-text">
                                    ...
                                    <?php else: ?>
                                        <p>
                                            En réglant aujourd'hui l'acompte de <?= $this->Number->currency($devisEntity->get('AccompteFormated'), 'EUR') ?>
                                        </p>
                                    <?php endif ?>
                                </div>
    ...
    <div class="header-option-wrapper hide-for-mobile">
        ...
        <div class="inner-header-option-wrapper">
            ...
            <div class="option-block option-block-border quotation-option-block current">
            ...
            <?php if ($devisEntity->model_type != null): /*si y'a pas de borne liée au modèle , ne pas afficher l'onglet brochure*/ ?>
            ...
            <div class="option-block booking-option-block">
    ...
    <div class="quotation-main-content-container">
        ...
        <div class="quotation-side-section quotation-detail-section">
            ...
            <div class="inner-quotation-detail-section">
                ...
                <div class="booking-step-container booking-step-one <?= $devisEntity->get('IsPartiallyPaid') || $devisEntity->status == 'paid' ? 'hide-step' : ''; ?>">
                    ...
                    <div class="booking-detail-container">
                        ...
                        <?php if($devisEntity->model_type == 'spherik') : ?>

                            <div class="special-offer-wrapper">
                                <div class="inner-paragraph-wrap">
                                    <p class="thicker-bold larger-text">
                                        Offre spéciale : livraison de la borne offerte sur le lieu de votre choix !
                                    </p>
                                    <p class="small-text">
                                        Conseil : n'attendez pas qu'il soit trop tard ! Réservez dès maintenant pour assurer la disponibilité de la borne à votre date et profiter de l'offre du moment. 
                                    </p>
                                </div>
                        ...
                        <div class="booking-instruction-wrapper">
                                    ...
                                    <div class="indication-text">
                                        <?php 
                                            ...
                                            if(!empty($devisEntity->date_evenement)){
                                                $arr = explode( '/', $devisEntity->date_evenement);
                                                if($arr[2] == '2021'){
                                                    $nbrImpression = "450";
                                                }
                                            }
                                        ?>
                                        <p class="thicker-bold larger-text">
                                            <?= $nbrImpression ?> impressions 10x15 cm (ou 800 impressions 5x15 cm) sans recharge
                                        </p>
                                        <p>
                            ...
                            <div class="mobile-bottom-button-block">
                                ...
                                <a class="quotation-button" target="_blank" href="<?= $this->Url->build($devisEntity->get('PublicPdfUrl'), true) ?>">
                                    Voir le devis en plein écran
                                </a>
                            ...
                            <div class="bottom-indication-wrap">
                                ...
                                <?php else: ?>
                                    <p class="sub-top-text bold">Réglez uniquement un acompte de <?= $this->Number->currency($devisEntity->get('AccompteFormated'), 'EUR') ?> aujourd'hui pour bloquer votre date !</p>
                ...
                <div class="booking-step-container booking-step-two  <?= !($devisEntity->get('IsPartiallyPaid') || $devisEntity->status == 'paid') ? 'hide-step' : ''; ?>">
                                            ...
                                            <div class="outer-booking-info-wrap">
                                                ...
                                                <?php if ($devisEntity->status != 'paid'): ?>
                                                    ...
                                                    <div class="booking-info-wrap top-booking-info-wrap mt-2">
                                                        ...
                                                        <div class="booking-amount medium-bold darker-gray-text">
                                                            <span class="amount-pay"> <?= $this->Number->currency($devisEntity->get('ResteEcheanceImpayee'), 'EUR'); ?></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <?php if (
                                                        ...
                                                        <div class="booking-info-wrap">
                                                            <div class="medium-bold darker-gray-text">
                                                                <label for="echeance-total_remaining">Document payé le <?= $devisEntity->date_total_paiement ?></label>
                                                            </div>
                                                            <div class="booking-amount medium-bold darker-gray-text">
                                                                <span class="amount-pay"> <?= $this->Number->currency($devisEntity->montant_total_paid, 'EUR'); ?></span>
                                                            </div>
                                                        </div>
                                                    <?php endif ?>
        ...
        <div class="quotation-side-section quotation-document-section">
            ...
            <div class="document-preview-wrapper quotation-preview-wrapper display hide-for-mobile">
                ...
                <?php $this->start('pdf_iframe') ?>
                    ...
                    <!--<iframe src="<?= $this->Url->build($devisEntity->get('PublicPdfUrl')) ?>" type="application/pdf" title="devis" class="object-pdf pdf-doc-file pdf-safari-desktop"></iframe>-->

                    <!--<iframe src="https://mozilla.github.io/pdf.js/web/viewer.html?file=<?= $this->Url->build($devisEntity->get('PublicPdfUrl'), true) ?>" width="100%" height="100%" class="pdf-doc-file pdf-desktop-all"></iframe>-->

                    <!--<iframe src="https://mozilla.github.io/pdf.js/es5/web/viewer.html?file=<?= $this->Url->build($devisEntity->get('PublicPdfUrl'), true) ?>" width="100%" height="100%"></iframe>-->
