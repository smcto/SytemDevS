...
<div class="devisFacturesProduits form large-9 medium-8 columns content">
    <?= $this->Form->create($devisFacturesProduit) ?>
    <fieldset>
        <legend><?= __('Add DevisFactures Produit') ?></legend>
        <?php
            ...
            echo $this->Form->control('invoice_id', ['options' => $devisFactures, 'empty' => true]);
