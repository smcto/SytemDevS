...
<body style="Margin:0;padding:0;background-color:#f6fafd;">
    <center class="wrapper" style="width:100%;table-layout:fixed;padding:30px 0;background-color:#f6fafd;">
                                                    ...
                                                    <tr>
                                                        <td class="outer-content-wrapper middle-section-wrapper" style="padding:0;border-top:1px solid #eceaeb;border-bottom:1px solid #eceaeb;padding:35px 22px 20px 22px;padding-bottom:39px !important;">
                                                            <table style="width:100%;border-spacing:0;">
                                                                ...
                                                                <?php if ($reglementEntity->montant_restant > 0): ?>
                                                                    <tr>
                                                                        <td style="padding:0;">
                                                                            <table style="width:100%;border-spacing:0;">
                                                                                <tr>
                                                                                    <td style="padding:0;text-align: center;padding-top: 30px;">
                                                                                        <p class="bold" style="font-size:13.4px;Margin:0;font-weight:600;">
                                                                                            Le total sera à régler avant le retrait de la borne.
                                                                                        </p>
                                                                                        <p style="font-size:13.4px;Margin:0;">
                                                                                            <span class="bold" style="font-weight:600;">Rappel du lien pour accéder au règlement :</span>&nbsp;<a href="<?= $this->Url->build($devisEntity->get('EncryptedUrl'), true) ?>" class="link bold" style="font-weight:600;color:#f95184;text-decoration:underline;">Voir le lien</a>.
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                                    ...
                                                                                    <table class="content" style="width:100%;border-spacing:0;">
                                                                                        <tr>
                                                                                            <td style="padding:0;">
                                                                                                ...
                                                                                                <p class="bold inner-detail-content" style="font-size:13.4px;Margin:0;font-weight:600;Margin-bottom:15px;">
                                                                                                    Contact réservation : <?= $devisEntity->client->nom ?>
                                                                                                </p>
                                                                                                <p class="bold inner-detail-content" style="font-size:13.4px;Margin:0;font-weight:600;Margin-bottom:15px;">
                                                                                                    <?php if($devisEntity->get('ClientType') == 'person' && $devisEntity->date_evenement != null) : ?>
                                                                                                        Week end du <?= $devisEntity->date_evenement->format('d/m/Y') ?> 
                                                                                                    <?php elseif ($devisEntity->date_evenement != null && $devisEntity->date_evenement_fin != null): ?>
                                                                                                ...
                                                                                                <p class="bold inner-detail-content" style="font-size:13.4px;Margin:0;font-weight:600;Margin-bottom:15px;">
                                                                                                    <?php if(!empty($devisEntity->lieu_evenement) && $devisEntity->model_type == 'spherik') : ?>
                                                                                                            Lieu événement : <?= $devisEntity->lieu_evenement ?>
                                                                                                    <?php elseif (!empty($devisEntity->get('LieuRetraitFormated'))): ?>
        ...
        <div class="webkit bottom-webkit" style="max-width:800px;padding:35px 53px 55px 53px;background-color:#ffffff;border-radius:6px;Margin:30px 0 40px 0;padding-bottom:20px;">
            <table class="outer" align="center" style="border-spacing:0;Margin:0 auto;width:100%;max-width:800px;font-family:Arial, Helvetica, sans-serif;color:#000000;">
                <tr>
                    <td style="padding:0;">
                        <table style="width:100%;border-spacing:0;">
                            <tr>
                                <td align="center" style="padding:0;">
                                    <p class="extra-bold larger-text bottom-webkit-title" style="Margin:0;font-size:18px;font-weight:900;Margin-bottom:28px;">
                                        Et ensuite ?</p>
                                    <p class="bold" style="font-size:13.4px;Margin:0;font-weight:600;">
                                        Notre équipe de gestion de projet prendra contact avec vous pour la mise en place de votre animation !</p>
                                    <p class="bold bottom-webkit-last-sentence" style="font-size:13.4px;Margin:0;font-weight:600;Margin:15px 0 30px 15px;">
                                        A très vite et merci de votre confiance.</p>
                                    <img src="https://www.selfizee.fr/email-images/selfizee-signature.jpg" alt="signature" width="130" style="border:0;" />
                                </td>
                            </tr>
                        </table>
                    </td>
