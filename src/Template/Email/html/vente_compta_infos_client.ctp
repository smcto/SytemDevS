...
<?php $this->start('old') ?>
    ...
    <p>
        <?= $venteEntity->client->nom ?> <?= $venteEntity->client->prenom ?> <br>
        <?= $venteEntity->client->email ? $venteEntity->client->email.'<br>' : '' ?>
        <?= $venteEntity->client->telephone ? $venteEntity->client->telephone.'<br>' : '' ?>
    ...
    <a href="<?= $host .''. $this->Url->build(['controller' => 'Ventes', 'action' => 'view', $venteEntity->id]) ?>">Voir la fiche de vente</a>
<?php $this->end() ?>
                                                                            ...
                                                                            <tr>
                                                                                <td style="padding:0;">
                                                                                    <table class="content" style="width:100%;border-spacing:0;">
                                                                                        <tr>
                                                                                            <td style="padding:0;">
                                                                                                <p class="larger-text" style="font-size:13.4px;Margin:0;font-size:15px;">
                                                                                                    <?= $venteEntity->client->nom ?> <?= $venteEntity->client->prenom ?> <br>
                                                                                                    <?= $venteEntity->client->email ? $venteEntity->client->email.'<br>' : '' ?>
                                                                                                    <?= $venteEntity->client->telephone ? $venteEntity->client->telephone.'<br>' : '' ?>
                                                                                                    <?= $venteEntity->client->adresse ? $venteEntity->client->adresse.'<br>' : '' ?>
                                                                                ...
                                                                                <td class="inner-padding" style="padding:0;padding-bottom:5px;">
                                                                                    <table class="content" style="width:100%;border-spacing:0;">
                                                                                        <tr>
                                                                                            <td style="padding:0;">
                                                                                                <p class="larger-text extra-bold inner-detail-content amount" style="font-size:13.4px;Margin:0;word-spacing:-1.5px;font-size:15px;Margin-bottom:15px;">
                                                                                                    <?= $venteEntity->gamme_borne->name ? $venteEntity->gamme_borne->name . ' / ' : '' ?> <?= $venteEntity->model_borne->nom ?? '' ?> &nbsp;
                                                                                                </p>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                ...
                                                                                <td class="inner-padding" style="padding:0;padding-bottom:5px;">
                                                                                    <table class="content" style="width:100%;border-spacing:0;">
                                                                                        <tr>
                                                                                            <td style="padding:0;">
                                                                                                <p class="larger-text extra-bold inner-detail-content amount" style="font-size:13.4px;Margin:0;word-spacing:-1.5px;font-size:15px;Margin-bottom:15px;">
                                                                                                    <?= $venteEntity->livraison_date ? $venteEntity->livraison_date->format('d/m/Y') : '' ?>
                                                                                                </p>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
