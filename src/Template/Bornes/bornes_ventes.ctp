    ...
    <tbody>
        <?php foreach ($bornes as $key => $borne) { ?>
            ...
            <tr>
                ...
                <td></td>
                <td><?= isset($vente) ? $vente->is_abonnement_bo ? 'Oui' : 'Non' : '' ?></td>
                <td><?= $borne->contrat_debut ?></td>
                <td><?= $borne->get('GarantieDureeMois') ?></td>
                <td><?= $borne->user ? $borne->user->get('FullName') : '' ?></td>
                <td>
                    <div class="dropdown d-inline container-bornes-actions">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="<?= $this->Url->build(['action' => 'editGarentie', $borne->id]) ?>">Modifier vente</a>
