...
<div class="col-lg-12">
    <div class="card card-outline-info">
        <div class="card-header">
            <h4 class="m-b-0 text-white">Ajout d'un ticket pour la borne numéro: <?= @$borne->model_borne->gammes_borne->notation . $borne->numero ?></h4>
        </div>
        <div class="card-body">
                ...
                <div class="form-body">
                    <div class="row p-t-20">
                        ...
                        <div class="col-md-6 hide">
                             <?php echo $this->Form->control('borne_id',['label' => 'Borne ','type'=>'text', 'value'=>$borne->numero]); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->control('categorie_actus_id',['id'=>'categorie_actus_id','label' => 'Catégorie', 'options'=>$categorietickets_options,'empty'=>'Séléctionner']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                           <?php echo $this->Form->control('contenu',['label'=>'Contenu',"class"=>"textarea_editor form-control", "rows"=>"10",'type'=>'textarea']); ?>
                        </div>
                    </div>
                    <div class="row">
                         <div class="col-md-12">
