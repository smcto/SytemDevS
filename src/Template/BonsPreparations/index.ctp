...
$titrePage = "Liste bons de préparation" ;
                ...
                <?= $this->Form->end(); ?>
                    ...
                    <div class="table-responsive clearfix">
                        <table class="table">
                            ...
                            <tbody>
                                <?php foreach ($bonsPrepa as $key => $commande): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $commande->date_depart_atelier ? $commande->date_depart_atelier->format('d-m-Y') : '--' ?></td>
                                        ...
                                        <td>
                                                <div class="dropdown d-inline container-ventes-actions">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        ...
                                                        <a class="dropdown-item" href="<?= $this->Url->build(['action' => 'edit', $commande->id]) ?>" target="_blank">Modifer</a>
                                                    </div>
                                                </div>
                                        </td>
                                    </tr>
