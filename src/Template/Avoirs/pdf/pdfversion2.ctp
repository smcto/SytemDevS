...
<div class="card">
    <div class="indent">
        ...
        <span><?= $trans->translate('en', $target, 'Dated') ?>: <?= $avoirsEntity->date_crea ? $avoirsEntity->date_crea->format('d/m/Y') : "" ?></span><br><br>
    </div>
    <div class="card-body">
                    ...
                    <td style="vertical-align: top;">
                        <div>
                            ...
                            <span class="client_contact">
                                ...
                                <?= $trans->translate('en', $target, 'To the attention of') ?> <b><?= $avoirsEntity->avoir_client_contact->civilite ?> <?= $avoirsEntity->avoir_client_contact->full_name ?></b><br>
                                <?php endif; ?>
                            </span>
        ...
        <div class="objet"><?= $trans->translate('en', $target, 'Object') ?> : <?= @$avoirsEntity->get('ObjetToPdf') ?> </div>
                    ...
                    <tr style="vertical-align: top">
                        <td width="10cm">
                            <?php if($avoirsEntity->note) : ?>
                                <div class="note">
                                    <p><?= $trans->translate('en', $target, 'Note') ?> : </p> <?= $avoirsEntity->langue->note ?>
                                </div>
                            <?php endif ?>
                        </td>
                        <td>
                        ...
                        <td>
                            <table class="table table-uniforme table-reglement">
                                ...
                                <tr  class="text-right noborder">
                                    <td  width="70%">
                                        <?= $trans->translate('en', $target, 'Amount deducted from the invoice') ?> <br>
                                ...
                                <tr class="text-right">
                                    <td> <b><?= $trans->translate('fr', $target, 'Total to be paid') ?></b></td>
                                    <td> <b>
                                    <?php 
                ...
                <tbody>
                    ...
                    <?php if ($avoirsEntity->delai_reglements != 'echeances') : ?>
                        <tr>
                            ...
                            <td><span id="del_regl" class="innfo-regl"><?= $trans->translate('fr', $target, @$delai_reglements[$avoirsEntity->delai_reglements]) ?></span></td>
                        </tr>
                    <?php else : ?>
        ...
        <div class="auto-break">
            <div class="condition-paiem"><p><?= $avoirsEntity->langue->retard ?></p></div> 
        </div>
        <?php endif ?>
    </div>
</div>
