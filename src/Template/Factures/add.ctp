...
<?php /*$this->Html->script('factures/uploadmultiple.js',['block'=>true])*/ ?>
<?= $this->Html->script('factures/factures.js',['block'=>true]) ?>
<?= $this->Html->script('factures/produits.js?time='.time(),['block'=>true]) ?>
<?php
$titrePage = "Ajout d'une nouvelle facture" ;
        ...
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                ...
                <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <?php //echo $this->Form->control('antenne_id',['label' => 'Antenne *','type'=>'select', 'options'=>$antennes, 'empty'=>'Selectionner']); ?>
                        </div>
                    </div>
                    <?php } else {?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->control('titre',['label' => 'Titre *','type'=>'text', 'required']); ?>
                        </div>
                        <div class="col-md-6">
                            <?= $this->Form->control('evenement_id',['label' => 'Projet *', 'required', 'type'=>'select', 'options'=>$evenements, 'empty'=>'Sélectionner']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <?php echo $this->Form->control('facture_file',["id"=>"facture_id","label"=>"Facture ","class"=>"dropify", "type"=>"file"]) ?>
                        </div>
                    </div>
                    ...
                    <div class="row-fluid">
                        ...
                        <table class="table mt-2">
                            ...
                            <tbody class="products-table">
                                <tr>
                                    <td><?= $this->Form->select('factures_produits.0.type_equipement_id', $typeEquipements, ['empty' => 'Sélectionner', 'required', 'input-name' => 'type_equipement_id', 'class' => 'form-control', 'id' => 'type_equipement_id']); ?></td>
                                    <td><?= $this->Form->select('factures_produits.0.equipement_id', [], ['input-name' => 'equipement_id', 'required', 'class' => 'form-control', 'id' => 'equipement_id']); ?></td>
                                    <td><?= $this->Form->control('factures_produits.0.qty', ['input-name' => 'qty', 'type' => 'number', 'label' => false, 'class' => 'form-control', 'id' => 'qty']); ?></td>
                                    <td><?= $this->Form->select('factures_produits.0.parc_id', $parcs, ['input-name' => 'parc_id', 'type' => 'number', 'required', 'label' => false, 'class' => 'form-control', 'id' => 'qty']); ?></td>
                                    <td><a href="" class="mt-2 d-block" id="remove-prod"><i class="mdi mdi-delete text-inverse"></i></a></td>
                                </tr>
                            </tbody>
                            <tfoot>
