        ...
        <div class="outer-popup-container">
            ...
            <div class="inner-popup-container customized-scrollbar white-background-scrollbar">
                ...
                <div class="top-header-wrapper">
                    <div class="left-section">
                        <div class="quotation-name">
                            Facture DK-XXXXXXXXX
                        </div>
                        <div class="status-wrap">
                            <div class="status-icon partiel"></div>
                            <div class="text">Règlement partiel</div>
                        </div>
                        ...
                        <div class="issue-type-wrap">
                            Événement mal passé
                        </div>
                    </div>

                    <div class="right-section">
                        <div class="amount-to-pay-wrapper total-wrapper">
                            <div class="top-label">Total facture</div>
                            <div class="ttc-amount">400 &euro; TTC</div>
                            <div class="ht-amount">360 &euro; HT</div>
                        </div>
                        <div class="amount-to-pay-wrapper rest-to-pay-wrapper">
                ...
                <div class="middle-header-wrapper">
                    <div class="left-section">
                        <div class="inner-date-wrapper">
                            <div class="label">
                                Prochaine échéance :
                            </div>
                            <div class="value">
                                règlement prévu le 2 octobre
                            </div>
                        </div>
                        <div class="inner-date-wrapper">
                            <div class="label">
                ...
                <div class="popup-detail-wrapper client-detail-wrapper display">
                    <div class="left-section">
                        <div class="vertical-block">
                            <div class="company-type-wrap">
                                <div class="editable-block title">
                                    <input type="text" class="editable-text label" placeholder="Nom de société / association / particulier" value="Eliel Brancard" />
                                </div>
                            </div>
                            ...
                            <div class="client-info-wrapper">
                                ...
                                <div class="customized-select">
                                    <div class="selected-value-block">
                                        <div class="text value" option-id="1">Particulier</div>
                                        <div>
                                            <svg viewBox="0 0 256 256"><path d="M225.813 48.907L128 146.72 30.187 48.907 0 79.093l128 128 128-128z"></path></svg>
                                        </div>
                                    </div>
                                    ...
                                    <div class="outer-option-list-wrap">
                                        <div class="option-list-wrap">
                                            ...
                                            <div class="inner-option-list-wrap customized-scrollbar white-background-scrollbar">
                                                <div class="option-block selected value" type-value="person" option-id="1">
                                                    Particulier
                                                </div>
                                                <div class="option-block value" type-value="corporation" option-id="2">
                                                    Professionnel
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="vertical-block professional-client-data-wrapper">
                            ...
                            <div class="inner-left-section">
                                <div class="phone-number-wrap">
                                    ...
                                    <div class="value">+33614781546</div>
                                </div>
                            </div>

                            <div class="inner-right-section">
                                <div class="inner-right-data-wrap professional-data">
                                    <div class="label">
                                        SIRET :
                                    </div>
                                    <div class="value">00000000000000</div>
                                </div>
                                ...
                                <div class="inner-right-data-wrap professional-data tva-number-wrap">
                                    <div class="label">
                        ...
                        <div class="vertical-block professional-client-data-wrapper below-left-client-wrapper">
                            <div class="inner-left-section">
                                <div class="inner-data-wrap client-group-wrap professional-data">
                                    <div class="label">
                                        Groupe de clients :
                                    </div>
                                    ...
                                    <div class="customized-select">
                                        <div class="selected-value-block">
                                            <div class="text value" option-id="1">Sélectionner</div>
                                            <div>
                                                <svg viewBox="0 0 256 256"><path d="M225.813 48.907L128 146.72 30.187 48.907 0 79.093l128 128 128-128z"></path></svg>
                                            </div>
                                        </div>
                                        ...
                                        <div class="outer-option-list-wrap">
                                            <div class="option-list-wrap">
                                                ...
                                                <div class="inner-option-list-wrap customized-scrollbar white-background-scrollbar">
                                                    ...
                                                    <div class="option-block value" option-id="5">
                                                        Leclerc
                                                    </div>
                                                    <div class="option-block value" option-id="6">
                                                        VandB
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="customized-select">
                                        ...
                                        <div class="outer-option-list-wrap">
                                            <div class="option-list-wrap">
                                                ...
                                                <div class="inner-option-list-wrap customized-scrollbar white-background-scrollbar">
                                                    <div class="option-block value" option-id="1">
                                                        Sélectionner
                                                    </div>
                                                    <div class="option-block value" option-id="2">
                                                        Site internet
                                                    ...
                                                    <div class="option-block value" option-id="3">
                                                        Recommandation d'un ami / contact
                                                    </div>
                                                    <div class="option-block value" option-id="4">
                                                        Découvert lors d'un événement
                                                    </div>
                                                    <div class="option-block value" option-id="5">
                                                        Salon
                                                    </div>
                                                    <div class="option-block value" option-id="6">
                                                        Rencontre avec quelqu'un de notre équipe
                                                    </div>
                                                    <div class="option-block value" option-id="7">
                                                        Réseaux sociaux
                                                    </div>
                                                    <div class="option-block value" option-id="8">
                                                        Recommandation partenaire professionnel
                                                    </div>
                                                    <div class="option-block value" option-id="9">
                                                        Document pub papier
                                                    </div>
                                                    <div class="option-block value" option-id="10">
                                                        Autre
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="inner-right-section">
                                <div class="inner-data-wrap activity-type-wrap professional-data">
                                    <div class="label">
                                        Secteur d'activité :
                                    </div>
                ...
                <div class="popup-detail-wrapper doc-section">
                    <div class="inner-document-wrapper">
                        ...
                        <div class="bottom-table-btn-wrap">
