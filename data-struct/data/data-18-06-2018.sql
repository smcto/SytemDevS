...
CREATE TABLE `bornes` (
  ...
  CONSTRAINT `fk_bornes_model_bornes1` FOREIGN KEY (`model_borne_id`) REFERENCES `model_bornes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (1,'Gris',7);
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (2,'Rouge',7);
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (3,'Verte',8);
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (4,'Blanche',8);
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (5,'Noir',9);
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (6,'Noir',9);
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (7,'Noir',10);
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (8,'Noir',10);
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (9,'Noir',11);
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (10,'Noir',12);
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (11,'Noir',12);
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (12,'Noir',12);
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (13,'Noir',12);
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (14,'Noir',12);
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (15,'Noir',12);
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (16,'Noir',12);
insert  into `couleur_possibles`(`id`,`couleur`,`model_borne_id`) values (17,'Noir',12);
...
CREATE TABLE `fournisseurs` (
  ...
  CONSTRAINT `FK_fournisseurs_type` FOREIGN KEY (`type_fournisseur_id`) REFERENCES `type_fournisseurs` (`id`),
...
/*Table structure for table `type_fournisseurs` */
...
/*Data for the table `type_fournisseurs` */
