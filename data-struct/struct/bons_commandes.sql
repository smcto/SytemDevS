...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 03 déc. 2020 à 18:51
...
--
-- Structure de la table `bons_commandes`
--

DROP TABLE IF EXISTS `bons_commandes`;
CREATE TABLE `bons_commandes` (
  ...
  `is_prepa` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'si = 1 la commande est en preparation'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Structure de la table `bons_commandes_produits`
--

DROP TABLE IF EXISTS `bons_commandes_produits`;
CREATE TABLE `bons_commandes_produits` (
  `id` int(11) NOT NULL,
  `bons_commande_id` int(11) NOT NULL,
...
--
-- Index pour la table `bons_commandes`
--
ALTER TABLE `bons_commandes`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `bons_commandes_produits`
--
ALTER TABLE `bons_commandes_produits`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `bons_commandes`
--
ALTER TABLE `bons_commandes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `bons_commandes_produits`
--
ALTER TABLE `bons_commandes_produits`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
