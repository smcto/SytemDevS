$(document).ready(function(){
    ...
    var responsiveDesktopScreen = 1254;
    ...
    $(document).on('click', 'header .inner-header-wrapper .burger-menu-wrap', function(){
        ...
        // Remove wave effect from header setting
        $(this).parents('header').find('.header-settings-wrapper .inner-header-settings-wrap').removeClass('waves-effect');
    ...
    $(window).resize(function(){
        ...
        if( window.matchMedia('(min-width: ' + ( responsiveDesktopScreen + 1 ) + 'px)').matches && mainMenuUrls.length ) {
            ...
            // Add wave effect to header setting
            $('header .inner-header-wrapper .header-settings-wrapper .inner-header-settings-wrap').addClass('waves-effect');
    ...
    if( navigator.userAgent.indexOf("Firefox") > -1 ) {
        ...
        $('header .inner-header-wrapper .header-settings-wrapper .inner-header-settings-wrap .text').css('margin-top', '3px');
    ...
    $(document).on('click keypress', 'header .inner-header-wrapper .header-search-wrapper .header-search-wrap input.header-input-search', function(){
        ...
        if( !searchSubNav.parents('.header-search-wrapper').find('input.header-input-search').val() && !searchSubNav.hasClass('display') ) {
            ...
            searchSubNav.find('.search-zone-wrapper .zone-block input.search-zone-type').prop('checked', false);
        ...
        $(this).parents('.header-search-wrapper').find('.sub-nav-wrapper').addClass('display');
    ...
    $(document).on('click', 'header .header-search-wrapper .search-zone-wrapper .search-button-wrapper .search-button', function(){

        // Check if at least one checkbox is checked

        if( searchSubNav.find('.search-zone-wrapper .zone-block .input-check-wrap input.search-zone-type:checked').length > 0 && searchSubNav.parents('.header-search-wrapper').find('input.header-input-search').val() ) {
    ...
    function removeSearchSubNav() {
        ...
        searchSubNav.removeClass('display');
    ...
    $(document).on('click', 'header .inner-header-wrapper .header-search-wrapper .sub-nav-wrapper .search-zone-wrapper .zone-block', function(){
        ...
        $(this).parents('.search-zone-wrapper').find('.zone-block').removeClass('checked');
        $(this).parents('.search-zone-wrapper').find('.zone-block input.search-zone-type').prop('checked', false);
        ...
        if( $(this).hasClass('checked') ) {
            ...
            $(this).find('input.search-zone-type').prop('checked', true);

        } else {

            $(this).find('input.search-zone-type').prop('checked', false);
        }
