$(document).ready(function(){
    ...
    // === Responsive header for 1288px screen and below ===
    ...
    if( window.matchMedia('(max-width: 1288px)').matches ) {
        ...
        $('header .inner-header-wrapper .nav-wrapper .nav-block').each(function(){
            ...
            var url = $(this).find('a.main-nav-wrapper').attr('href');
            var menuText = $(this).find('a.main-nav-wrapper .text').text();

            $(this).find('a.main-nav-wrapper').parents('.nav-block').find('.sub-nav-wrapper').prepend('<a href="' + url + '" class="sub-nav-block">' + menuText + '</a>');
        ...
        // --***-- End of section to Display sub-menu --***--

    }

    // === End of Responsive header for 1288px screen and below ===


    // === Responsive header for 767px screen and below ===
    ...
    // === End of Responsive header for 767px screen and below ===
