$(document).ready(function(){
    ...
    let lineGeneralSumCanvas = document.querySelector('.encaissement-dashboard-wrapper .all-chart-wrapper .general-summary-block.bar-chart-sum-block canvas').getContext('2d');
