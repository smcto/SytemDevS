$(document).ready(function(){
    ...
    let pieGeneralSumCanvas = document.querySelector('.encaissement-dashboard-wrapper .all-chart-wrapper .general-summary-block .pie-chart-wrapper canvas').getContext('2d');
    ...
    populateChartLegend( $('.encaissement-dashboard-wrapper .all-chart-wrapper .general-summary-block .pie-chart-wrapper .legend-wrapper'), pieGeneralChartData, pieGeneralAmounts );
                ...
                data: [
                    {
                        ...
                        x: new Date("2020-6-10"),
                        y: 1745
                    },{
                        x: new Date("2020-7-27"),
                        y: 2300
                    },{
                        x: new Date("2020-8-19"),
                        y: 985
                    },{
                        x: new Date("2020-9-18"),
                        y: 1240
                    },{
                ...
                data: [
                    {
                        ...
                        x: new Date("2020-4-24"),
                        y: 5410
                    },{
                        x: new Date("2020-5-21"),
                        y: 987
                    },{
                ...
                data: [
                    {
                        ...
                        x: new Date("2020-5-27"),
                        y: 120
                    },{
                        x: new Date("2020-6-16"),
                        y: 600
                    },{
                        x: new Date("2020-7-4"),
                        y: 841
                ...
                data: [
                    {
                        ...
                        x: new Date("2020-5-13"),
                        y: 784
                    },{
                        x: new Date("2020-6-5"),
                        y: 930
                    },{
                        x: new Date("2020-7-28"),
                        y: 6745
                    },{
                        x: new Date("2020-8-31"),
                        y: 2160
                    },{
                        x: new Date("2020-9-1"),
                        y: 7410
                ...
                data: [
                    {
                        ...
                        x: new Date("2020-7-10"),
                        y: 520
                    },{
                        x: new Date("2020-8-12"),
                        y: 4123
                    },{
                        x: new Date("2020-9-7"),
                        y: 2000
    ...
    let lineGeneralSumCanvas = document.querySelector('.encaissement-dashboard-wrapper .all-chart-wrapper .general-summary-block .line-chart-wrapper canvas').getContext('2d');

    let lineGeneralChartData = new Chart(lineGeneralSumCanvas, {

        //type: 'line',
        type: 'bar',
        data: lineGeneralData,
        options: {
    ...
    let piePaymentSumCanvas = document.querySelector('.encaissement-dashboard-wrapper .all-chart-wrapper .payment-type-summary-block .pie-chart-wrapper canvas').getContext('2d');
    ...
    // Call function to populate legend for Payment Type Chart
    populateChartLegend( $('.encaissement-dashboard-wrapper .all-chart-wrapper .payment-type-summary-block .pie-chart-wrapper .legend-wrapper'), piePaymentChartData, piePaymentAmounts );
    ...
    let linePaymentSumCanvas = document.querySelector('.encaissement-dashboard-wrapper .all-chart-wrapper .payment-type-summary-block .line-chart-wrapper canvas').getContext('2d');
    ...
    let pieBankSumCanvas = document.querySelector('.encaissement-dashboard-wrapper .all-chart-wrapper .bank-summary-block .pie-chart-wrapper canvas').getContext('2d');
    ...
    // Call function to populate legend for Payment Type Chart
    populateChartLegend( $('.encaissement-dashboard-wrapper .all-chart-wrapper .bank-summary-block .pie-chart-wrapper .legend-wrapper'), pieBankChartData, pieBankAmounts );
    ...
    let lineBankSumCanvas = document.querySelector('.encaissement-dashboard-wrapper .all-chart-wrapper .bank-summary-block .line-chart-wrapper canvas').getContext('2d');
