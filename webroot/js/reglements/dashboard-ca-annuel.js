$(document).ready(function(){
    ...
    var summaryBlockClass = '.chiffre-affaires-dashboard-wrapper .all-chart-wrapper .general-summary-block';
    ...
    var devisAmounts = [40000, 60000, 55000, 30000];

    var devisData = {

        labels: ["Selfizee pro", "Selfizee part", "Selfizee loc'fi", "Selfizee achat"],
        datasets: [{
            data: getDataPercents(devisAmounts),
            backgroundColor: ['#01caf1', '#22ca80', '#ff4f70', '#fcba03']
        }]
    };

    var summaryBlockClass = '.chiffre-affaires-dashboard-wrapper .all-chart-wrapper .devis-summary-block';
    ...
    var summaryBlockClass = '.chiffre-affaires-dashboard-wrapper .all-chart-wrapper .commercial-summary-block';
