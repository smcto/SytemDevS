$(document).ready(function(){
    ...
    $(document).on('mousedown', '.card-kanban', function(e) {
        ...
        //$(document).on('mouseup mousemove', '.card-kanban', function handleMouseEvent(e) {
    ...
    $("body" ).on( "click", ".popup-detail-wrapper .inner-detail-wrapper .popup-detail-block", function() {
    ...
    $("body" ).on( "click, focusin", ".editable-text", function() {
        $(this).parents('.editable-block').addClass('editing');

    });

    //$('.editable-text').on('blur, focusout', function(){
    $("body" ).on( "blur, focusout", ".editable-text", function() {
    ...
    $("body" ).on( "click", ".popup-pipe-header .right-header-section .amount .editable-text", function() {
    ...
    $("body" ).on( "blur", ".popup-pipe-header .right-header-section .amount .editable-text", function() {
    ...
    $("body" ).on( "click", ".pipe-popup-container .client-event-tab-section .tab-block", function() {
    ...
    $( "body" ).on( "click", ".popup-below-tab-section .tab-block", function() {
    ...
    $("body" ).on( "click", ".client-detail-wrapper .right-section .contact-person-wrap .edit-icon-wrap", function() {
