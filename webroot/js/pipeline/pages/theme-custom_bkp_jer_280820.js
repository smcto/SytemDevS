$(document).ready(function(){
    ...
    $(document).on('mousedown', '.card-kanban', function(e) {
        ...
        var currentColdId = $(this).parents('.kanban-col').attr('id');
        ...
        $('.card-kanban').on('mouseup mousemove', function handleMouseEvent(e) {
            ...
            if( $(this).hasClass('draggable-source--placed') ) {
                ...
                if( currentColdId != newColId ) {
                    ...
                    console.log( $(this).parents('.kanban-col').attr('id') );
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(data){
                        ...
                        // Display datepicker
                        $('[data-toggle="pipeline-datepicker"]').datepicker({ autoHide: true });
                    }
                },
            });
    ...
    $(document ).on( "click", ".pipe-popup-container .client-event-tab-section .tab-block", function() {
    ...
    $(document).on('click', '.popup-container .bottom-submit-btn-wrap .btn-validate', function(e) {
   ...
   // $('.client-detail-wrapper .client-info-wrapper .customized-select .option-list-wrap .option-block').on('click', function(){
    ...
    $(document).on( "click", '.toggle-option-block', function() {
    ...
    $(document).on( "click", ".popup-below-header-wrapper .right-section .edit-icon-wrap", function() {
    ...
    $(document).on( "click", '.tag-container textarea', function() {
